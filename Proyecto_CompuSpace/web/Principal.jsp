<%-- 
    Document   : Principal
    Created on : 11-sep-2021, 20:49:49
    Author     : Alejandro
--%>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-info">
            ...
            <div class="dropdown" style="padding-left: 25px">
                <button style="border:none" class="btn btn-light dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
